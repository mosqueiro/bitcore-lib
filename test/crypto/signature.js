...
var sig_canonical = require('../data/smartcashd/sig_canonical');
var sig_noncanonical = require('../data/smartcashd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('smartcashd fixtures', function() {
