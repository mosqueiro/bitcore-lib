...
var script_valid = require('../data/smartcashd/script_valid');
var script_invalid = require('../data/smartcashd/script_invalid');
var tx_valid = require('../data/smartcashd/tx_valid');
var tx_invalid = require('../data/smartcashd/tx_invalid');

//the script string format used in smartcashd data tests
Script.fromsmartcashdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromsmartcashdString(vector[0]);
    var scriptPubkey = Script.fromsmartcashdString(vector[1]);
  ...
  describe('smartcashd script evaluation fixtures', function() {
  ...
  describe('smartcashd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //smartcashd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromsmartcashdString(scriptPubKeyStr);
          });
